...
public class AddressDaoImpl<T> implements AddressDao<T> {
	...
	private final Class<T> persistentClass = (Class<T>) Address.class;
	...
	public void save(T entity) {
		// TODO Auto-generated method stub
		System.out.println((Address)entity);
	...
	public void deleteAll() {
		...
		final List<?> instances = getSession().createCriteria(Address.class).list();
